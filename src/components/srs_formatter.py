...
from src.components.srs_template import (
    AnnotatedRequirement,
    SRSTemplate,
    SmartFlag
)
from src.components.conversation_state import ConversationState
from src.components.system_prompt.prompt_architect import IEEE830_CATEGORIES, MANDATORY_NFR_CATEGORIES
from src.components.domain_discovery.domain_discovery import NFR_CATEGORIES
from src.components.srs_coverage import render_section2_extras, render_section35_stub
...
class SRSFormatter:
    ...
    def _render_header(
        ...
        w("| Status | Generated by RE Assistant Iteration 6 |")
